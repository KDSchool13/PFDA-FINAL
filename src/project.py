def rock_or_swim(): 
 """Asks the user an a or b question, and upon answer calls the appropriate function to continue the story."""
...
def dance_or_decline():
   """Asks the user an a or b question, and upon answer prints the end of the story."""
...
def reef_or_air():
   ...
   if (answer == "a"):
      print("You urge yourself to hold your breath a little longer and meet your fish friend at the reef.\n""The school of fish immediatly surrounds you in a ticklish fishy embrace.\n"
            "The ocean fades to darkness around you, floating with your little fish friends.\n""<><><><><>\n""You lethargically blink crust out of your eyes as a cough comes from your burning throat.\n"
            "It takes you a moment to realize youre floating in the ocean, the waves moving you up and down.\n"
            "The sky is strangley pink and as your vision comes into focus, you realize youre peering up at a beautiful sunset.\n""You get the strange feeling that everything will be okay.\n")
   elif (answer == "b"):
